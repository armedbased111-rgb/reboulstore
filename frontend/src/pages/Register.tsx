  ...
  return (
    <div className="min-h-full grid grid-cols-1 lg:grid-cols-[478px_1fr] lg:gap-[10px] pb-[15px] pl-4 pr-[9px] pt-[10px]">
      ...
      <div className="lg:w-[478px]">
        <div className="w-full max-w-[478px] space-y-8">
          ...
          <div className="space-y-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-[1.5px]">
                <label htmlFor="firstName" className="block font-[Geist] font-medium text-[14px] leading-[20px] tracking-[0.35px] uppercase">
                  Prénom
                </label>
                <input
                  id="firstName"
              ...
              {/* Nom */}
              <div className="space-y-[1.5px]">
                <label htmlFor="lastName" className="block font-[Geist] font-medium text-[14px] leading-[20px] tracking-[0.35px] uppercase">
                  Nom
                </label>
                <input
                  id="lastName"
              ...
              {/* Téléphone */}
              <div className="space-y-[1.5px]">
                <label htmlFor="phone" className="block font-[Geist] font-medium text-[14px] leading-[20px] tracking-[0.35px] uppercase">
                  Téléphone
                </label>
                <input
                  id="phone"
              ...
              <div className="space-y-[1.5px]">
                ...
                <input
                  ...
                  className="w-full h-12 px-3 bg-white border border-black rounded-[2px] font-[Geist] text-[14px] placeholder:text-[rgba(0,0,0,0.5)] outline-none focus:ring-0"
                />
                <p className="text-xs text-[#4a5565] mt-1">Minimum 8 caractères</p>
              </div>

              {/* Confirm Password */}
              <div className="space-y-[1.5px]">
                <label htmlFor="confirmPassword" className="block font-[Geist] font-medium text-[14px] leading-[20px] tracking-[0.35px] uppercase">
