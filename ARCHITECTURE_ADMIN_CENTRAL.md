...
- [ ] Créer structure `admin-central/`
- [ ] Configurer backend avec connexion Reboul
- [ ] Copier entités Reboul dans `admin-central/backend/src/modules/reboul/entities/`
- [ ] Créer services Reboul (orders, products, stocks)
- [ ] Créer controllers Reboul
- [ ] Configurer frontend admin (React + GeistUI)
- [ ] Créer pages admin (dashboard, commandes, produits)
- [ ] Configurer Docker Compose admin
- [ ] Tester connexion admin → Reboul database
- [ ] Implémenter fonctionnalités MVP admin
...
**🎯 Prochaine étape** : Implémenter cette architecture dans la roadmap et commencer le développement de l'admin centralisé (Phase 16-17).
