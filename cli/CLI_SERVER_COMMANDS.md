# 🚀 CLI - Commandes de Gestion Serveur
...
**Cron jobs recommandés** : Voir `cli/CRON_JOBS_RECOMMENDATIONS.md`
...
- **BACKUP_EXPLAINED.md** : `cli/BACKUP_EXPLAINED.md` - Explications détaillées des backups
