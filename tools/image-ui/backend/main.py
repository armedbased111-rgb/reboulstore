...
from routers import brands, refs, images_serve, batch, batch2, batch3, upload, adjust, images_manage, campaign, hero, pil
...
app.include_router(batch3.router, prefix="/api")
